...
Ein Gespräch ist dann sinnvoll, wenn eine oder mehrere dieser Situationen auf euch zutreffen:
...
Wenn nichts davon passt, ist das ebenfalls eine wertvolle Erkenntnis. Dann kannst du die Fragestellung auch zunächst selbst strukturieren – z. B. im [KI-gestützten Notebook.LLM-Dialog](#Alternativ) weiter unten auf der Seite.
...
<details>
<summary><strong>Wenn es konkreter wird</strong></summary>

Ergibt sich im Gespräch eine klare Fragestellung, fasse ich die wichtigsten Punkte schriftlich zusammen und sende sie dir im Anschluss per E-Mail zu. Diese Zusammenfassung dient als gemeinsame Grundlage. Daraus ergeben sich – je nach Situation:

* ein weiterer Abstimmungstermin
* die Ausarbeitung eines Angebots
* oder die bewusste Entscheidung, zu einem späteren Zeitpunkt erneut zu sprechen
...
Das Gespräch endet nicht mit einer Empfehlung, sondern mit Klarheit. Du weißt danach, ob deine Fragestellung strategisch relevant ist – und ob ein nächster Schritt sinnvoll wäre oder nicht. Viele Entscheider nutzen dieses Gespräch genau für diese Einordnung.

[Einordnungsgespräch (30 Minuten) buchen](https://calendly.com/gerhard-schroeder/auf-eine-tasse-tee-mit-gerhard-schroder){.gh-button .cta-center}

Auch wenn eure Fragestellung noch nicht vollständig ausformuliert ist:  
Das Gespräch dient genau dieser Klärung.
