---
title: "Augmented Reality im Vertrieb"
slug: augmented-reality
status: published
meta_title: "Augmented Reality im Vertrieb | viSales NRW"
meta_description: "Augmented Reality im B2B-Vertrieb: kein App-Download, sofort auf iPhone und iPad. viSales setzt AR als Entscheidungswerkzeug ein — nicht als Show-Element."
...
published_at: "2025-11-16T16:01:24.000Z"
type: page
template: post
---

- **Augmented Reality macht Produkte im Kundengespräch physisch erfahrbar – ohne Musterkoffer, ohne Anreise, ohne Vorbereitung.**
- **viSales nutzt AR gezielt für den B2B-Vertrieb: für Verkaufsgespräche, Messeauftritte und Remote-Präsentationen.**
- **Funktioniert auf jedem iPhone und iPad ohne App – dank AR Quick Look und OpenUSD-Standard.**
...
*Von Bochum aus für Kunden in ganz Deutschland und international:* AR-Lösungen, die direkt im Kundengespräch funktionieren – ohne App, ohne Installationsaufwand.
...
<details>
<summary><strong>**AR im Sales – Vorteile für Vertrieb & Abschluss**</strong></summary>
...
* **Schneller Einstieg ins Erlebnis:** Dank [AR Quick Look](https://visales.de/wozu-braucht-man-ar-quick-look-von-apple/) und [USDZ-Formaten](https://visales.de/sechs-mythen-zum-openusd-standard-die-akte-usdz/) können KundInnen AR-Erlebnisse direkt über einen Link oder QR-Code starten – ohne App-Download, ohne lange Wartezeit.
...
→ [AR-gestützte Vertriebsdemonstration für industrielle Software](https://visales.de/siemens/)

[Embed: https://www.youtube.com/watch?v=sxZ2ugB4Abs](https://www.youtube.com/watch?v=sxZ2ugB4Abs)
...
<details>
<summary><strong>Weitere Beispiele aus realen Vertriebssituationen</strong></summary>
...
→ [VTOL-Konzept-Pitch von PanSpatial](https://www.youtube.com/watch?v=qz2mDm2KhGo) (ca. 4 Min.)
...
→ [Wie röstet man Kaffee? Erklärung via AR](https://www.youtube.com/watch?v=Norl0V4rALU) (ca. 2 Min.)
...
→ [PlugVan: Sales via Augmented Reality](https://www.youtube.com/watch?v=pUGc_V2mstQ) (ca. 7 Min.)
...
→ [Augmented Reality auf der Messe](https://www.youtube.com/watch?v=IzF6MKIztlo&list=PLIggDLmpuIxrseHgWAoPCLFs5VCFGkpGY&index=14&t=6s) (ca. 3 Min.)

Weitere AR-Lösungen für Messeeinsätze:

→ [AR auf Messen & Events](https://visales.de/messen/)
...
<details>
<summary><strong>Warum wir AR im Vertrieb pragmatisch umsetzen</strong></summary>

In vielen Vertriebsorganisationen sind iPhone und iPad ohnehin im Einsatz. Mit [Apple AR Quick Look](https://visales.de/wozu-braucht-man-ar-quick-look-von-apple/) steht eine AR-Engine bereits im Betriebssystem zur Verfügung – **ohne zusätzliche Apps oder Installationen**.
...
Das hängt vom Einsatzzweck ab: viSales berät, welcher Weg sinnvoll ist – und bereitet die Daten so auf, dass sie für Spatial Presentation, AR, Meetings oder Messen langfristig nutzbar bleiben. Wie OpenUSD dabei als gemeinsames Datenformat funktioniert:
...
## Häufige Fragen zu Augmented Reality im Vertrieb

<details>
<summary><strong>Was ist Augmented Reality einfach erklärt?</strong></summary>

Augmented Reality blendet digitale Inhalte – 3D-Modelle, Animationen, Informationen – in die reale Umgebung ein. Auf dem Smartphone oder Tablet erscheint das digitale Objekt so, als würde es wirklich im Raum stehen.

</details>

<details>
<summary><strong>Wie setzt viSales AR im B2B-Vertrieb ein?</strong></summary>

viSales entwickelt AR-Anwendungen für Verkaufsgespräche: Produkte werden als USDZ-Dateien aufbereitet und direkt auf dem iPhone oder iPad gezeigt – in Originalgröße, im echten Raum des Kunden.

</details>

<details>
<summary><strong>Welche Unternehmen nutzen AR im Vertrieb?</strong></summary>

Industrieunternehmen wie Siemens, Somfy und zgoll setzen AR erfolgreich im Vertrieb ein. AR ermöglicht es, komplexe Anlagen und Konfigurationen ohne physisches Muster zu demonstrieren.

</details>

<details>
<summary><strong>Was kostet ein AR-Pilotprojekt?</strong></summary>

Der Einstieg beginnt mit einem Pilotprojekt: ein Produkt als 3D-Modell aufbereitet, für AR Quick Look optimiert, bereit für das nächste Kundengespräch. Die Kosten hängen von der Komplexität des Produktes ab – sprechen Sie uns an.

</details>

Produktkonfiguration mit AR und 3D: [USDconfig — AR-Konfigurator für B2B](https://visales.de/usdconfig/)
