---
title: "OpenUSD Dienstleister: viSales aus Bochum"
slug: openusd-dienstleister
status: published
meta_title: "OpenUSD Dienstleister & OpenUSD Agentur: viSales aus Bochum"
meta_description: "viSales ist OpenUSD-Dienstleister für B2B-Unternehmen: CAD-Daten zu AR, Web und Vision Pro. Spatial Sales Infrastructure — deployable, ohne App, mit Datenhoheit beim Kunden."
...
published_at: "2026-03-14T22:03:32.000Z"
type: post
template: post
---
...
<details>
<summary><strong>Red Flags: Daran erkennst du einen Anbieter, der es nicht wirklich kann</strong></summary>
...
**OpenUSD Beratung & Einordnung:** Strukturierte Ersteinordnung: Wo entstehen bei euch heute doppelte 3D-Datenwege? Wo lohnt OpenUSD, wo nicht? Ergebnis: klare Empfehlung, kein Pitch.
...
**Aktive Mitarbeit im OpenUSD-Ökosystem:** viSales ist Mitglied der [Alliance for OpenUSD (AOUSD)](https://aousd.org/) und des [Metaverse Standards Forum](https://metaverse-standards.org/) sowie Contributor der USD Working Group. Wir verfolgen die Standardentwicklung nicht nur als Anwender, sondern als Beteiligte.

## Projektbeispiele

**Siemens DDX — AR im Verkaufsgespräch mit Echtzeitbezug:** Interaktive AR-Anwendung für eine industrielle Blechpresse. Einsatz auf Messen und Vortragsbühnen. CAD-Ausgangsdaten, USDZ-Aufbereitung, Apple [AR Quick Look](https://visales.de/wozu-braucht-man-ar-quick-look-von-apple/).
...
→ [Projektvideo igus](https://www.youtube.com/watch?v=USMOYQ8uAIY&list=PLIggDLmpuIxrseHgWAoPCLFs5VCFGkpGY&index=15&ref=visales.de) (3:30 Minuten)
...
<details>
<summary><strong>Brauchen wir bereits 3D- oder CAD-Daten?</strong></summary>
...
<details>
<summary><strong>Funktioniert das auch mit unserem CAD-System?</strong></summary>
...
<details>
<summary><strong>Bleibt die Masterdatei bei uns?</strong></summary>
...
<details>
<summary><strong>Was kostet ein OpenUSD-Pilotprojekt?</strong></summary>
...
[Kostenloses Erstgespräch](https://visales.de/kontakt){.gh-button .cta-center}

## Weiterführend

→ [OpenUSD für Entscheider](https://visales.de/openusd/) (Einordnung & Hintergrund)  
→ [OpenUSD FAQ: Typische Entscheiderfragen](https://visales.de/openusd-faq/)  
→ [AR-Beispiele aus dem Vertriebsalltag](https://visales.de/augmented-reality/)

Unsere OpenUSD-Tools: [USDconfig](https://visales.de/usdconfig/) (3D-Konfigurator) und [USDbridge](https://visales.de/usdbridge/) (Format-Konverter).
