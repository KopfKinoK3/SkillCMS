...
published_at: "2025-12-30T16:46:25.000Z"
type: post
template: post
---
...
→ [Fallbeispiel DDX](https://visales.de/augmented_reality-data-driven-x-siemens-fallbeispiel/) mit Projektvideo (8:30 Minuten)
...
→ [Fallbeispiel Somfy](https://visales.de/somfy/) mit Projekt-/Award-Video (9:50 Minuten)
...
→ [Fallbeispiel zgoll:](https://visales.de/zgoll/) mit Augmented Reality-Demo
...
→ [Fallbeispiel Carl Hamm](https://visales.de/vr-video_immersive_video_vr180_fallbeispiel-carl-hamm/) mit Projekt-Video im Format VR180 (5:00 Minuten)

*Weitere Einordnungen finden sich auf der *[*Carl-Hamm-Gesamtprojektübersicht*](https://visales.de/carl-hamm/)*.*
...
→ [Projektvideo igus](https://www.youtube.com/watch?v=USMOYQ8uAIY&list=PLIggDLmpuIxrseHgWAoPCLFs5VCFGkpGY&index=15) (3:30 Minuten)
...
→ [Projektvideo igus](https://www.youtube.com/watch?v=dDTESsqB8HI) (6:30 Minuten)

&nbsp;

<details>
<summary><strong>Weitere Projektbeispiele & Einblicke</strong></summary>
...
→ [Fallbeispiel Wavin](https://visales.de/wavin/) (360/Video)
...
→ [Fallbeispiel K+S](https://visales.de/k-s-360-video/)
...
→ [Fallbeispiel DIEGOSat](https://visales.de/astrofein/)
...
→ [Fallbeispiel Wavin](https://visales.de/wavin-360-video/) (Digitale Musterstadt)
...
→ [Einordnung](https://visales.de/einordnung/)
