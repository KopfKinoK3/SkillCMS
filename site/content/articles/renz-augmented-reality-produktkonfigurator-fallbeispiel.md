---
title: "Fallbeispiel RENZ: Verkauf beginnt mit Erleben"
slug: renz-augmented-reality-produktkonfigurator-fallbeispiel
status: published
primary_tag: visual-sales
tags: [visual-sales, produktkonfigurator, vertriebskommunikation, case-study]
feature_image: /assets/images/2025/11/Fallbeispiel_RENZ.jpeg
...
[Live-Demo](https://media.visales.de/USDconfig/player.html?engineId=&allowResize=0&placeVertical=0&glbUrl=https://visales.de/assets/Showtime_%5BPaket%5D.glb&variantSet=Paket,Hocker%7CStart_Up%7CIdea_Lab%7CWorkshop,Workshop&variantSet=Farbe,Natur%7CBerry%7CSage%7CCoral%7CWhite%7CLagoon%7CLemon%7COlive,Natur&variantSet=Filz,ohne%7Cmit,mit&usdzUrl=https://visales.de/assets/ShowTime_UsdConfig_TK_20062025.usdz){.gh-button .cta-center}

Während Karl und Anton zwei fiktive Personas meiner Newsletters-Reihe sind ist [Matthias Renz](https://www.linkedin.com/in/mathiasrenz/) der reale Geschäftsführer der Firma [Wilhelm Renz GmbH + Co. KG](https://www.renz.de/), eines Kunden meiner Firma viSales GmbH.

Heute möchte ich unser neues Produkt **USDconfig** vorstellen. Es ist also im doppelten Sinne **Showtime** ([Hersteller-Website](https://www.renz.de/produktekategorien/showtime)), für den Hocker und unseren Hockerkonfigurator in OpenUSD. Ein paar Funktionen sind im LinkedIn- und Email-Newsletter als Bilder umgesetzt, auf unserer Website hingegen gibt es die [Livedemo](https://visales.de/USDconfig/player.html?engineId=&allowResize=0&placeVertical=0&glbUrl=https://visales.de/assets/Showtime_%5BPaket%5D.glb&variantSet=Paket,Hocker%7CStart_Up%7CIdea_Lab%7CWorkshop,Workshop&variantSet=Farbe,Natur%7CBerry%7CSage%7CCoral%7CWhite%7CLagoon%7CLemon%7COlive,Natur&variantSet=Filz,ohne%7Cmit,mit&usdzUrl=https://visales.de/assets/ShowTime_UsdConfig_TK_20062025.usdz).

**Viel Spaß beim Lesen, sei es bei einer Tasse Tee, oder Kaffee!**

![](/assets/images/2025/11/Produktkonfigurator_iPad_AR_Renz.jpeg)
...
3D-Konfiguratoren sorgen bei vielen Händlern für Conversion-Steigerungen von bis zu 94 %. 82 % der Besucher klicken freiwillig auf die 3D-Ansicht – ohne dass man sie dazu auffordern muss. 66 % sagen, dass solche Tools ihnen beim Kaufen helfen. Und AR? Liefert teils über 250 % bessere Ergebnisse – weil es eben kein Video ist, sondern Erleben. ([Quelle](https://visales.de/blog/kosten-nutzen-von-augmented-reality-im-vertrieb))
...
![](/assets/images/2025/11/Produktkonfigurator_Desktop_AR_Renz.jpeg)
...
![](/assets/images/2025/11/Produktkonfigurator_iPhone_AR_Renz.jpeg)
...
![](/assets/images/2025/11/Apple_Vision_Pro_AR_Produktkonfigurator_Renz.jpeg)
...
**Was wir anbieten:** Ein Schnelltest mit eurem Produkt. Wir analysieren eure bestehende Datei oder entwickeln gemeinsam eine erste Konfiguration. Im Videocall zeigen wir live, wie euer Produkt in Web und AR aussehen und verkaufen könnte.

**Was ihr braucht:** Eine 3D-Datei oder Produktidee. Und den Wunsch, euren Vertrieb sichtbarer, moderner und verständlicher zu machen.

**3 Plätze. 1 Datei. 0 Ausreden.** Wer zuerst kommt, konfiguriert zuerst. Hauptsache, ihr erlebt es selbst: Schreibt mich auf LinkedIn einfach an -&gt; [Gerhard Schröder](https://www.linkedin.com/in/gerhardschroeder/), oder ruft an: +49-160-8060361. Alternativ eine [Terminfindung zum Zoom-Call](https://visales.de/kontakt/). Ohne Verpflichtung, aber mit Aha-Effekt.
...
→ Mehr AR-Einsatzszenarien: [AR im B2B-Vertrieb – Anwendungsfälle](https://visales.de/augmented-reality/)

→ Mehr zu AR-Produktkonfiguratoren: [3D-Produktkonfigurator für den Vertrieb](https://visales.de/produktkonfigurator/)
