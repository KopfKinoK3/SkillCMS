---
title: "1. Warum unsere neue Website bewusst viele Texte enthält und was KI damit zu tun hat"
slug: 1-warum-unsere-neue-website-bewusst-viele-texte-enthalt-und-was-ki-damit-zu-tun-hat
status: published
primary_tag: schroders-notizen
tags: [schroders-notizen, aus-der-agentur, ki]
meta_title: "Warum unsere neue Website bewusst auf Texte setzt"
meta_description: "Warum Texte heute mehr sind als Erklärung: Sie schaffen Kontext für Menschen, Einordnung für KI und bessere Entscheidungsgrundlagen im Vertrieb."
feature_image: /assets/images/2025/12/ueber_visales_2-2.png
...
published_at: "2026-01-18T07:05:20.000Z"
type: post
template: post
ki_text: true
ki_bild: true
...
>   
> Der Visual-Sales-Newsletter begann 2022 unter dem Namen ***Schröders Notizen**** (*[*Erste Ausgabe*](https://visales.de/synthesized-reality-apples-masterplan-fur-ar-vr/)*)*. Damals ging es weniger um Projekte als um Gedanken, Einordnungen und Fragen rund um Präsentation, Vertrieb und viel OpenUSD-Technologie. Für diese begrenzte Textreihe kehre ich bewusst zu diesem Namen zurück.  
>   
...
>   
> Der reguläre [VisualSales-Newsletter](https://visales.de/ueber-uns/#/portal/signup) läuft parallel wie gewohnt weiter – mit Projektbeispielen, Einordnungen und neuen Themen. Diese Serie hier ist davon bewusst getrennt.  
>   
> Vor ein paar Tagen erschien zum Relaunch eine Nullnummer auf der Website: [0. Über den Relaunch](https://visales.de/0-uber-den-2026er-relaunch).   
>   
...
Klassische Suchmaschinenoptimierung war der Anfang. Was heute entsteht, geht weiter: [Generative Engine Optimization](https://visales.de/seo-ist-tot-es-lebe-aeo/). KI-Systeme bewerten nicht nur Seiten, sondern Denkmodelle. Sie bevorzugen Inhalte, die:
...
Ein persönlicher Punkt spielt ebenfalls eine Rolle: Ich habe über Jahre erlebt, wie groß der Erklärbedarf bei Themen wie AR, 3D, [Spatial Presentation](https://visales.de/spatial-presentation/) oder [OpenUSD](https://visales.de/openusd/) ist – und wie selten er offen adressiert wird.
...
[Über das Notebook-LLM können Leser gezielt Fragen stellen und sich Antworten generieren lassen](https://notebooklm.google.com/notebook/8214e4ca-dd3d-4420-9cc5-be74370ea3ed?authuser=1) – auf Basis genau dieser Inhalte, Vorträge und Projekterfahrungen. Nicht als Chatbot mit Verkaufsabsicht, sondern als Denkwerkzeug.
...
Wenn du nun prüfen möchtest, ob viSales für eure Fragestellung der richtige Partner ist, **sprich direkt mit mir**: 
