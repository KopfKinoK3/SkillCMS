---
title: "11. Wie ich heute Texte erstelle und warum KI dabei hilft, aber nicht entscheidet"
slug: 11-wie-ich-heute-texte-erstelle-und-warum-ki-dabei-hilft-aber-nicht-entscheidet
status: published
primary_tag: schroders-notizen
tags: [schroders-notizen]
feature_image: /assets/images/2026/03/Texten-und-Tee.jpg
...
Als ich mir vorgenommen habe, die neue Website für die Agentur allein zu texten, ohne Kollegen Thomas Schupp - unserem echt guten Teamredakteur - war mir eines von Anfang an klar: [Diese Texte müssen erklärungsfähig sein – für Menschen und für KI](https://visales.de/1-warum-unsere-neue-website-bewusst-viele-texte-enthalt-und-was-ki-damit-zu-tun-hat/).
...
<details>
<summary><strong>Wie ich heute Texte erstelle (Rohtext aus dem Arbeitsprozess – unredigiert)</strong></summary>
...
<details>
<summary><strong>Die Fragen und meine Antworten</strong></summary>

ChatGPT: Gut. Ich stelle dir **keine Verständnisfragen**, sondern **kluge, strukturierende Rückfragen**, die dir helfen, Text 11 zu schärfen, ohne ihn zu verwässern. Nimm sie nicht als To-do-Liste, sondern als Denkspiegel.

**1. Ziel & Leser (entscheidend)**

1. **Für wen ist dieser Text** ***nicht*** **geschrieben?**  
...
2. **Was soll ein Leser nach Text 11 besser verstehen als nach Text 10?**  
   Deinen Denkprozess?  
...
3. **Was wäre ein Missverständnis, das du mit diesem Text unbedingt vermeiden willst?**  
...
4. Du beschreibst ChatGPT als **Sparringspartner**.  
...
6. Würdest du sagen, dass ChatGPT bei dir eher:
7. * strukturiert
   * zuspitzt
   * widerspricht
   * ordnet
...
7. Warum war es wichtig, die Personal Branding Canvas **noch einmal neu** zu machen – und nicht einfach zu übernehmen?
...
8. **Was hat sich durch die Arbeit mit der Canvas konkret verändert?**  
   Themen?  
   Ton?  
...
10. Du vergleichst die Website mit Gutenbergs Bibel.  
...
11. Du schreibst: „Viele Bilder würde eine KI sowieso nicht erkennen können.“  
...
12. Was wäre aus deiner Sicht heute gefährlicher:
13. * zu wenig Text
    * oder zu viel visuelle Ablenkung?

Antwort: "Zu viel visuelle Ablenkung."

**5. KI, Zitierfähigkeit, SEO (sensibler Teil)**

13. Wenn du von „zitierfähigen Mustern“ sprichst:  
    **Meinst du Sätze, Denkmodelle oder Begriffe?**

Antwort: "Denkmodelle"

14. Schreibst du Texte heute eher für:
15. * Menschen
    * Suchmaschinen
    * KI-Modelle  
...
15. Würdest du sagen, dass sich deine Texte **verlangsamen**, damit sie besser verstanden werden?

Antwort: "Besser strukturieren, Zwischenüberschriften…"

**6. Der Box-Gedanke (sehr gut, aber prüfenswert)**

16. **Warum willst du den Rohtext inkl. Fehler zeigen?**  
    Transparenz?  
    Haltung?  
    Abgrenzung?
...
17. Was soll ein Leser fühlen, wenn er diese Box liest?
18. * Vertrauen
    * Nähe
    * Respekt
    * Irritation?
...
19. **Ist Text 11 ein Abschluss oder ein Übergang?**  
...
20. Welche **eine** Aussage dürfte jemand nach dem Lesen zitieren?
...
Alle Rohtexte, die für diese Website entstanden sind, habe ich in ein Projekt mit ChatGPT überführt. Dort lag kein leerer Prompt, sondern ein klares Briefing. Vor allem zwei Dinge: eine kritische Haltung gegenüber meinen eigenen Gedanken – und die Leitplanken aus der [Personal Branding Canvas von Dr. Kerstin Hoffmann](https://www.kerstin-hoffmann.de/pr-doktor/personal-branding-canvas/). Danke Kerstin - Diese Arbeit sollten sich alle Kommunikatoren machen, die eigene Leinwand (Canvas) aufziehen vor dem Losmalen mit Fingerfarben...
...
Manche ChatGPT-Ansätze waren so kopflastig, dass ich den Rechner zugeklappt habe. Dann entsteht **Klarheit nicht** mehr **am Bildschirm**. Sie entsteht beim aus dem Fenster schauen, beim Spazierengehen oder – in diesen Tagen – beim Schneeschippen. Interessanterweise sind mir genau dort oft die besseren Strukturen eingefallen. Zum Beispiel die Idee, Projektbeispiele auf der [Messeseite](https://visales.de/messen/) nicht nach Branchen oder Formaten zu sortieren, sondern nach dem benötigten Quadratmeterbedarf.
...
**Die Canvas ist für mich** kein Kreativwerkzeug. Sie ist **ein Filter**. Ein Korrektiv. Und am Ende eine Entscheidungsgrundlage. Sie hilft mir nicht dabei, neue Themen zu finden, sondern dabei, Themen konsequent wegzulassen: Stichwort [Content-Ampel,](https://www.kerstin-hoffmann.de/pr-doktor/content-ampel-qualitaetscheck-infografik/) ebenfalls von K. Hoffmann entwickelt.
...
<details>
<summary><strong>So sind die Fallbeispiel-Newsletter-Beiträge aufgebaut</strong></summary>
...
Wer noch etwas bleiben möchte: [Die Texte dieser Reihe habe ich hier gesammelt](https://visales.de/tag/schroders-notizen/).
