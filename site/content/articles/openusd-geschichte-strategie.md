---
title: "Die Vorgeschichte zu OpenUSD"
slug: openusd-geschichte-strategie
status: published
primary_tag: visual-sales
tags: [visual-sales, openusd]
meta_title: "OpenUSD: Geschichte, Akteure & Industriepolitik hinter dem 3D-Standard"
meta_description: "Von Pixar über Apple und NVIDIA: Wer steckt hinter OpenUSD und warum? Die Backstory des offenen 3D-Standards — und was das für Maschinenbau und Industrie bedeutet."
feature_image: /assets/images/2026/01/OpenUSD_Pixar_Apple_Nvidia_Omniverse_AOUSD.png
...
published_at: "2026-01-06T17:49:14.000Z"
type: post
template: post
faq:
  - q: "Wer hat OpenUSD entwickelt und wann?"
    a: "OpenUSD wurde 2015 von Pixar erstmals öffentlich vorgestellt und 2016 als Open-Source-Projekt freigegeben. Ziel war es, komplexe Filmszenen über viele Abteilungen hinweg konsistent zu organisieren. 2023 wurde das Projekt in die Alliance for OpenUSD (AOUSD) überführt und unter dem Dach der Linux Foundation als neutraler Industriestandard weiterentwickelt."
  - q: "Was ist die Alliance for OpenUSD (AOUSD) und wer gehört dazu?"
    a: "Die AOUSD wurde 2023 gegründet, um OpenUSD von einzelnen Unternehmensinteressen zu lösen und als branchenneutralen Standard zu etablieren. Mitglieder sind u.&nbsp;a. Siemens, BMW, Mercedes-Benz, Apple, NVIDIA, Microsoft und Google. Die Core-Spezifikation 1.0 wurde am 17.12.2025 veröffentlicht; eine Weiterentwicklung zum IEEE-Standard ist für 2026 geplant."
  - q: "Was ist der Unterschied zwischen OpenUSD und glTF?"
    a: "glTF (*.glb) ist auf performante Darstellung im Browser und auf mobilen Geräten optimiert – ideal für E-Commerce-AR und Web-Visualisierungen. OpenUSD ist für strukturierte Weiterverarbeitung, Versionierung und paralleles Arbeiten an komplexen 3D-Daten ausgelegt. Das Metaverse Standards Forum legte USDZ als übergeordnetes Masterformat fest, aus dem glTF abgeleitet werden kann."
  - q: "Warum sind Microsoft und Google 2025 zu OpenUSD gewechselt?"
...
USD -später OpenUSD- wurde 2015 von [Pixar](https://www.pixar.com) erstmals öffentlich vorgestellt und 2016 als Open-Source-Projekt freigegeben. Ziel war es, komplexe Filmszenen über viele Abteilungen hinweg konsistent zu organisieren und weiterzuentwickeln.

Von Beginn an unterstützte **Apple** diesen Ansatz und brachte eigene Erweiterungen in das Projekt ein. **Google** entschied sich hingegen gegen USD und setzte stattdessen auf das alternative Format glTF der [Khronos Group](https://www.khronos.org/).
...
[Embed: https://www.youtube.com/watch?v=Wa6nTcNs_ys&list=PLIggDLmpuIxpsopYvLRgBD_9Ugbd9VZcZ&index=23&t=20s](https://www.youtube.com/watch?v=Wa6nTcNs_ys&list=PLIggDLmpuIxpsopYvLRgBD_9Ugbd9VZcZ&index=23&t=20s)

→ Alternative: [Die OpenUSD-Story](https://www.youtube.com/watch?v=CaEEOJmD3Zo&list=PLIggDLmpuIxqVKu9rrX_wxd_tueBs0jGd&index=9) (ca. 30 Min)
...
Diese Fragmentierung der drei Wege (Pixar, Apple & NVIDIA) führte 2023 zur Gründung der **Alliance for OpenUSD** ([AOUSD](https://aousd.org/?ref=visales.de)). Im Zuge dessen wurde USD offiziell in **OpenUSD** umbenannt – auch, um Verwechslungen mit der Abkürzung für den US-Dollar zu vermeiden.

Mit der AOUSD wurden die Rechte von Pixar abgegeben und in die Verantwortung der [Linux Foundation](https://www.linuxfoundation.org/) überführt. Damit wurde die Grundlage für die Neutralität von OpenUSD als branchenübergreifendem Standard geschaffen.
...
2023 wurde ein mehrjähriger Vereinheitlichungsplan aufgesetzt. Am 17.12.2025 wurde die [Core-Spezifikation 1.0](https://aousd.org/news/core-spec-announcement/) veröffentlicht. Eine zentrale Aufgabe der AOUSD ist es, diese Spezifikation zu einem [IEEE-Standard](https://de.wikipedia.org/wiki/Institute_of_Electrical_and_Electronics_Engineers) weiterzuführen. Der entsprechende Prozess soll 2026 abgeschlossen werden.
...
- [BIM](https://www.bmv.de/DE/Themen/Mobilitaet/BIM-und-Digitale-Zwillinge/Building-Information-Modeling/building-information-modeling.html)-Integration,
- sowie Gaussian Splats als mögliche Bestandteile zukünftiger Core-Versionen (1.x).

Der AOUSD gehören heute zahlreiche Industrieunternehmen weltweit an, darunter **Siemens**, **BMW**, **Mercedes‑Benz**, viele internationale 3D-Softwareanbieter – und bereits früh auch die Agentur [viSales](https://visales.de/) aus Bochum.

[Embed: https://www.youtube.com/watch?v=4fyWRfcXXz0&list=PLIggDLmpuIxpsopYvLRgBD_9Ugbd9VZcZ&index=20&pp=gAQBiAQBsAgC](https://www.youtube.com/watch?v=4fyWRfcXXz0&list=PLIggDLmpuIxpsopYvLRgBD_9Ugbd9VZcZ&index=20&pp=gAQBiAQBsAgC)

→ Vortrags-Mitschnitt: [Die AOUSD-Roadmap](https://youtu.be/4fyWRfcXXz0) (ca. 35 Min.)
...
**Persönliche Einschätzung von **[**Gerhard Schröder**](https://www.linkedin.com/in/gerhardschroeder/)**, **  
...
Die Geschichte von OpenUSD zeigt, warum der Standard heute strategisch relevant ist. Was das konkret für Unternehmen bedeutet, steht in der Übersicht: [**OpenUSD für Entscheider**](https://visales.de/openusd/)
