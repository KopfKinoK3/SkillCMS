---
title: "Von CAD zu AR: Wie 3D-Daten Ihre Verkaufszahlen revolutionieren können."
slug: cad_usdz_openusd_augmented_reality_sales
status: published
primary_tag: visual-sales
tags: [visual-sales, openusd, usdz, 3d-visualisierung, vertriebskommunikation]
meta_title: "Von CAD zu AR: 3D-Daten im Vertrieb einsetzen | viSales"
meta_description: "Wie B2B-Unternehmen CAD-Daten direkt für Augmented Reality und AR-Vertriebspräsentationen nutzen – ohne doppelte Aufbereitung. Mit OpenUSD & USDZ."
feature_image: /assets/images/2025/11/3D_Sales.jpeg
...
published_at: "2024-11-26T07:00:00.000Z"
type: post
template: post
faq:
  - q: "Kann ich meine CAD-Daten direkt für AR im Vertrieb nutzen?"
    a: "Ja – CAD-Daten sind die ideale Ausgangsbasis für AR. Mit dem richtigen Workflow lassen sich bestehende CAD-Modelle (CATIA, SolidWorks, STEP) in USDZ konvertieren und sofort auf dem Smartphone als AR-Exponat einsetzen – ohne Neumodellierung."
  - q: "Was ist der Unterschied zwischen CAD-Datei und USDZ?"
    a: "CAD-Dateien sind für technische Konstruktion optimiert – mit Maßgenauigkeit, Baugruppen und Metadaten. USDZ ist ein visualisierungsoptimiertes 3D-Format für AR und Web. Die Konvertierung reduziert Komplexität gezielt, damit das Modell auf mobilen Geräten flüssig läuft."
  - q: "Welche Branchen profitieren am meisten von CAD-zu-AR im Vertrieb?"
...
1. Karl, der Geschäftsführer: Was hat die Firma im kaufmännischen Sinne und als größere Strategie von einem solchen Umstellung der Daten?
2. Franz, der Vertriebsleiter (ggf. auch Marketing-Leiter): Wie kann durch 3D-Inhalte und Augmented Reality (AR) der Verkauf gestärkt werden?
3. Anton: Leiter die Konstruktionsabteilung, ist für die Anlieferung der 3D-Daten zur weiteren Bearbeitung zuständig. Auch diese Sichtweise ist von großer Bedeutung für den Projekt- und Unternehemenserfolg.
...
Nehmen wir eine Maschinenbaufirma als Beispiel: Technische Zeichnungen einer Konstruktion gibt es schon seit langer Zeit. Ich war vor einigen Monaten in einer [DaVinci-Ausstellung in Wuppertal](https://visiodrom.de/show-ausstellungen/leonardo-da-vinci-2023/), nicht erst seit diesem Universalgenie werden technische Geräte zu Papier gebracht.
...
![Artikelinhalte](/assets/images/2025/11/Gitterlinien.png)
...
[Embed: https://www.youtube.com/watch?v=M61PI52ZtbE](https://www.youtube.com/watch?v=M61PI52ZtbE)

> *"...Erfahrungen aus den letzten Veranstaltungen , bei den wir gerade mal eine Präsentationsfläche von 2x3 m hatten. Auf 6 m² ein Exponat unterzubringen ist schon eine Aufgabe, wenn man unsere Produkte kennt, aber das Exponat auch noch interessant zu präsentieren, ist ohne Bewegung nicht möglich. Das Auge sieht zwar alles, aber "gecatcht" wird es nur von Bewegung, Interaktion! Gleiches gilt natürlich auch für eine Gesamtpräsentation! ****Als Vertriebler, kann, soll und muss ich meinem Gegenüber soviel Informationen bieten wie nötig/möglich, aber noch so schöne Worte können nicht das beschreiben, was das Auge selber sieht und als Information in's Hirn weiterleitet.****" *[Thomas Kernchen](https://www.linkedin.com/in/thomas-kernchen-68261425/)[*, Prokurist unseres Kunden Carl Hamm zum Beitrag "*](https://www.linkedin.com/pulse/smarter-sales-auf-einer-messe-messeexponat-kombiniert-schr%C3%B6der-kkvof/)[**Messeerfolg maximieren: Exponate durch Augmented Reality aufwerten"**](https://www.linkedin.com/pulse/smarter-sales-auf-einer-messe-messeexponat-kombiniert-schr%C3%B6der-kkvof/)
...
[Embed: https://www.youtube.com/watch?v=dDTESsqB8HI](https://www.youtube.com/watch?v=dDTESsqB8HI)

*Video-Fallbeispiel *[igus GmbH](https://www.linkedin.com/company/igusgmbh/) *TRX: CAD- zu AR-Daten*
...
1. CAD-Daten aus der Konstruktionsabteilung
2. 3D-Grafikdaten von der Werbeagentur, je nach Agentur in einem anderen Format als „die andere Werbeagentur“. Bei einem Agenturwechsel kann das zu hohen Folgekosten oder einer Bindung an einen externen Dienstleister führen
3. AR oder VR-Daten von der AR-/VR-Agentur
...
1. **glb** (glTF-Standard von Google): Kann genutzt werden um statische oder einfach animierte 3D-Objekte im Browser / der Website anzuzeigen oder um diese Dateien, fast immer mit Anbindung an die Google-Datenserver, als AR-Element auf dem Smartphone anzuzeigen.
...
*Video: Weitere Unterschiede zwischen den beiden Formaten, als Video von mir. *[*Weitere Videos in meinem YouTube-Kanal*](https://www.youtube.com/@Gerhard_Schroeder)*.*
...
1. [HowTo: Sales mit AR](https://www.linkedin.com/pulse/howto-sales-mit-ar-gerhard-schr%C3%B6der/)
2. [Fünf Lösungen zur Augmented Reality-Hardware im Vertrieb](https://www.linkedin.com/pulse/f%C3%BCnf-l%C3%B6sungen-zur-augmented-reality-hardware-im-gerhard-schr%C3%B6der/)
3. [Sales im Industrial Metaverse](https://www.linkedin.com/pulse/sales-im-industrial-metaverse-gerhard-schr%C3%B6der/)
4. [Drei Ideen zu Messen, ganz ohne Apples Vision Pro](https://www.linkedin.com/pulse/drei-ideen-zu-messen-ganz-ohne-apples-vision-pro-gerhard-schr%C3%B6der-1mfoe/)
5. [Willkommen in der Zukunft: Wie 3D-Spatial-Websites das Web mit "Augments“ verwandeln](https://www.linkedin.com/pulse/willkommen-der-zukunft-wie-3d-spatial-websites-das-web-schr%C3%B6der-3k15e/)
6. [Messeerfolg maximieren: Exponate durch Augmented Reality aufwerten](https://www.linkedin.com/pulse/smarter-sales-auf-einer-messe-messeexponat-kombiniert-schr%C3%B6der-kkvof/)
...
- Nicht alle Kunden sind technikaffin: Einige Ihrer B2B-Kunden könnten skeptisch gegenüber AR-Anwendungen sein. Für diese Zielgruppen gibt es ja neben den bisherigen Darstellungsformen - [und sei es eine interaktive Powerpoint](https://www.youtube.com/watch?v=9AhoxkPPolU&list=PLIggDLmpuIxrseHgWAoPCLFs5VCFGkpGY&index=6) - viele weitere Aufbereitungsformen (Beispiele), die leicht aus der USDZ-Fassung erzeugt werden können. Der umgekehrte Weg ist jedoch nicht möglich.
...
> „Wenn noch nicht geschehen, sollte man sich mit der Erstellung von AR-fähigen Inhalten beschäftigen, es wird die Zukunft beherrschen.“ [Thomas Brandt, Bundeswehr zu meinem Vortrag vor seinen 130+ KameradInnen](https://www.linkedin.com/feed/update/urn:li:activity:7266701508518277120/)
...
1. Welcher RAL-Farbton für den Kunststoff genau? Blau ist eine recht grobe Angabe. Hausfarben aus dem Kunden-Designmanual müssen ebenfalls eingearbeitet werden
2. Welchen Glanz hat das Metall genau? Am Ende soll es ja möglichst naturgetreu aussehen und nicht unnatürlich - und selbst wenn für Werbezwecke dann ein „Bonuslook“ vergeben werden soll - die Basisdaten helfen das „Design-Delta" zu definieren
3. Wie bewegt sich die Baugruppe genau? Gibt es Gelenke? Scharniere? Oft erhalten wir von den CAD-Teams Einzeldateien und steigen dann mit Konstrukteuren und Produktmanagern in die Diskussion ein: Wie genau geht… Wann genau… Wie schnell kann sich der Gelenkarm drehen? (Nach "zu schnell“ kommt ja AB!)
...
Nun ist nur noch die Frage welche der drei Personas im Unternehmen Karl, Franz oder Anton den ersten Schritt gehen mag und meinem Unternehmen, einem DER USDZ-Spezialisten in Deutschland, eine Testdatei zuschickt. Die letzte Anfrage erfolgte vor ein paar Tagen von einem Geschäftsführer, der Sonntags beim Frühstück via Google Suche mein Unternehmen fand und direkt eine Email schrieb. Anfragen gern via [LinkedIn-Nachricht](https://www.linkedin.com/in/gerhardschroeder/), [Zoom-Call-Terminanfrage](https://calendly.com/gerhard-schroeder/auf-eine-tasse-tee-mit-gerhard-schroder?back=1&month=2024-12) oder guter, alter Email.
