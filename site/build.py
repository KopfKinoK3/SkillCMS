...
INLINE_CSS = """
        ...
        /* Abstand unter Content-Bildern — Bild + Unterschrift nicht gedrungen */
        .gh-content p img {
            display: block;
            margin-bottom: 0.6rem;
        }
        .gh-content p:has(img) {
...
def build_post_article_html(meta, content_html, is_draft=False):
    ...
    # KI-Attribution: ki_text/ki_bild (boolean) oder text_credit/image_credit (string)
    if meta.get("ki_text"):
        text_credit = "Kopf & KI"
    else:
